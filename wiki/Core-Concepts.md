...
Concurrent-tagged tools: `fetch_page`, `invoke_subagent`, `calculator`, `send_http_request`, `fetch_google_rss`, `transcribe_media`. `search_web`, write-class tools, `api_*`, and MCP tools always run serially.
